...
from onmt.modules.variational_dropout import VariationalDropout
from onmt.modules.weight_dropped_lstm import WeightDroppedLSTM
...
__all__ = ["Elementwise", "context_gate_factory", "ContextGate",
           ...
           "TiedEmbeddingLinear", "VariationalDropout", "WeightDroppedLSTM"]
